              ...
              <div className="service-item">
                ...
                <div className="desc-service-wrapper">
                  <div className="desc-service">
                    <p>
                      Ensuring the highest level of availability, performance
                      and security Analysis and engineering of computer systems
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="col col-d-6 col-t-6 col-m-12 border-line-h">
              <div className="service-item">
                ...
                <div className="desc-service-wrapper">
                  <div className="desc-service">
                    <p>
                      Proficient in Linux stacks, Definition and implementation
                      of best practices and standards, Design, build and
                      maintain Linux-based services at HPC scale operating
                      systems and applications to increase performance and
                      reliability
                    </p>
                  </div>
                </div>
            ...
            <div className="col col-d-6 col-t-6 col-m-12 border-line-h">
              <div className="service-item">
                ...
                <div className="desc-service-wrapper">
                  <div className="desc-service">
                    <p>
                      Designing and implementing VMware solutions,
                      troubleshooting VMware environment problems. Using VMware
                      to connect to the network and clouds
                    </p>
                  </div>
                </div>
              </div>
